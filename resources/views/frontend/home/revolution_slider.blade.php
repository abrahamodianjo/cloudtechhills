    ...
    <div id="rev_slider" class="rev_slider fullscreenbanner">
        <ul>
            @foreach ($banner as $item)
                <!-- Slide 1 -->
                <li data-delay="5000" data-transition="slideoververtical" data-slotamount="7" data-masterspeed="2000"
                    data-fsmasterspeed="1000">

                    <!-- Main image-->
                    <img src="{{ asset($item->image) }}" alt="" data-bgposition="center right"
                    ...
                    <div class="slide-title tp-caption tp-resizeme text-left text-center-sm"
                        ...
                        data-fontsize="['60','55', '55', '125']" data-fontweight="600"
                        data-lineheight="['70','65', '65', '135']" data-width="['750','750','650']" data-height="none"
                        ...
                        data-start="500" data-color="#fff" data-splitin="chars" data-splitout="none"
                        data-responsive_offset="on" data-elementdelay="0.05">{{ $item->title }}
                    </div>
                    ...
                    <div class="slide-subtitle tp-caption tp-resizeme text-left text-center-sm"
                        ...
                        data-fontsize="['18', '18', '18', '18']" data-fontweight="400" data-lineheight="['30']"
                        ...
                        data-start="1500" data-color="#fff" data-splitin="none" data-splitout="none">{{ $item->sub_title }}
                    </div>

                    <!-- Layer 3 -->
                    <div class="tp-caption rev-btn tp-resizeme slider-btn button-primary" id="slide-1081-layer-130"
                        data-x="['left','left','center','center']" data-hoffset="['0','0','0','0']"
                        data-y="['middle','middle','middle','middle']" data-voffset="['110','110','110','30']"
                        data-fontsize="['13','13','13','13']" data-fontweight="600"
                        data-lineheight="['50','50','50','50']" data-width="['150','150','150','200']"
                        data-height="none" data-whitespace="nowrap" data-start="2500" data-type="button"
